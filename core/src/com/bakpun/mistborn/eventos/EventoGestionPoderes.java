...
public interface EventoGestionPoderes extends EventListener{	//Este evento no lo ponemos en Poder porque ya el metodo abstracto quemar() funciona asi.
	void reducirPoder(TipoPersonaje tipoPj,TipoPoder tipoPoder,float energia,int id);
	void aumentarPoder(TipoPersonaje tipoPj,TipoPoder tipoPoder, float energia,int id);
}		
