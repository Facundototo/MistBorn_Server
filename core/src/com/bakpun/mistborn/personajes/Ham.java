...
public final class Ham extends Personaje{
	...
	public Ham(World mundo, Entradas entradas,Colision c,OrthographicCamera cam,Spawn spawn,int id) {
		super(Recursos.PERSONAJE_HAM,Recursos.SALTOS_HAM,Recursos.ANIMACIONES_ESTADOS_HAM, mundo, entradas,c,cam,spawn,TipoPersonaje.VIOLENTO,id);
	}
